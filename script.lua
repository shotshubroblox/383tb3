...
frame.BackgroundColor3 = Color3.fromRGB(183, 0, 0)
...
--experiment end]]
            ...
            do -- \\ Local Player Tab
                ...
                CharacterModsSection:toggle({type = "toggle", name = "Car Fly (not working)", flag = "carfly", default = false, callback = function(state)
...
local function checkPlayers()
    for _, plr in ipairs(Players:GetPlayers()) do
        ...
        if blacklist[plr.Name] then
            print("Cash is my daddy", plr.Name)
            continue
        end
